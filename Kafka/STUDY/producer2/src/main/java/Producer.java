...
public class Producer {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        while(true) {
            ...
            ArrayList<HashMap<String, String>> list = crawlingTime(now);
    ...
    public static ArrayList<HashMap<String, String>> crawlingTime(LocalDateTime initTime) throws IOException {
        // 현재 시간 기준 15분 이내의 기사만 가져오기
        ArrayList<HashMap<String, String>> list = new ArrayList<>();

        DateTimeFormatter sdf = DateTimeFormatter.ofPattern("yyyy.MM.dd. HH:mm");

        String URL = "https://news.naver.com/main/list.naver?mode=LPOD&mid=sec&oid=025&listType=title&date=20220322&page=" + 1;
        ...
        outer: for (Element ulEle : element.select("li")) {
            ...
            for (Element e : tag) {
                ...
                if (initTime.isBefore(newsDate)) {
                    ...
                    map.put("url", newsUrl);
                    map.put("time", String.valueOf(newsDate));
